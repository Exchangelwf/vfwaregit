...
#ifndef __NETWORKSERVICE_SYSTEMM_API_H__
#define __NETWORKSERVICE_SYSTEMM_API_H__
...
//#endif
	...
	typedef enum enNVR_DECODER_MODE_
	{
	    ENUM_NVR_DECODER_MODE_1_1080P,
	    ENUM_NVR_DECODER_MODE_2_1080P,
	    ENUM_NVR_DECODER_MODE_4_1080P,
	    ENUM_NVR_DECODER_MODE_4_720P,
	    ENUM_NVR_DECODER_MODE_8_720P,
	    ENUM_NVR_DECODER_MODE_8_D1,
	    ENUM_NVR_DECODER_MODE_16_D1,
	    ENUM_NVR_DECODER_MODE_24_D1,

	    /*HVR*/    
	    ENUM_DVR_DECODER_MODE_4_D1_ENCODE,
	    ENUM_HVR_DECODER_MODE_2_D1_ENCODE_1_1080P_1D1,
	    ENUM_DVR_DECODER_MODE_8_D1_ENCODE,
	    ENUM_HVR_DECODER_MODE_4_D1_ENCODE_1_1080P_1_720P,
	    ENUM_DVR_DECODER_MODE_16_D1_ENCODE,
	    ENUM_HVR_DECODER_MODE_8_D1_ENCODE_2_1080P_2_720P,
	    
	    ENUM_NVR_DECODER_MODE_BUTT
	}NVR_DECODER_MODE;
	    
	/// 获取系统硬件版本
	/* 先用这个接口获取NVR支持的类型切换，用掩码表示 */
...
#define	SYS_VGAPIXEL_1024x768			1		// 1024 x 768
	...
	typedef enum
	{
	    ENUM_VIDOUT_1920x1080p60 = 0, ///< 1920x1080p 60Hz
	    ...
	    ENUM_VIDOUT_800x600p60=4,
	    ENUM_VIDOUT_1920x1080i60=5,
	    ENUM_VIDOUT_NUM
	}enum_videout_type;
